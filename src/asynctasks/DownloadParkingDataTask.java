...
public class DownloadParkingDataTask extends AsyncTask<String,Void, String>{
	private AsyncTaskListener listener;
	public DownloadParkingDataTask(AsyncTaskListener listener){
